...
public:
	...
	static void setWindow(const std::string &name)
	{
		...
		root = std::make_unique<Widget>(0,0,SCR_WIDTH,SCR_HEIGHT,glm::vec3(1.0f,0.5f,0.5f));
...
int main()
{
	...
	Button btn2(30, 85, 100, 40, glm::vec3(0.5f, 1.0f, 0.0f), app.root.get());
	Button btn3(20, 20, 100, 40, glm::vec3(0.8f, 1.0f, 1.0f), &btn2);
